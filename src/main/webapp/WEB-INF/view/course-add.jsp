        ...
        <main class="lyear-layout-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header"><h4>新增课程</h4></div>
                            <div class="card-body">
                                <form id="courseForm" onsubmit="return false;">
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label>课程号</label>
                                            <input class="form-control" type="text" id="cno" placeholder="课程号">
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>教师工号</label>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>课程名</label>
                                            <input class="form-control" type="text" id="cname" placeholder="课程名">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>学分</label>
                                            <input class="form-control" type="text" id="credits" placeholder="如 3 或 2.5">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                    ...
                                    <div class="form-group">
                                        <label>课程内容</label>
                                        <textarea class="form-control" id="content" rows="3" placeholder="可选"></textarea>
                                    </div>
                                    <div class="form-group">
