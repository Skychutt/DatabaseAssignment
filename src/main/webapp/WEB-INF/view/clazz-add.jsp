                            ...
                            <div class="card-body">
                                <form id="clazzForm" onsubmit="return false;">
                                    <div class="form-group">
                                        <label>班级编号</label>
                                        <input class="form-control" type="text" name="clazzno" id="clazzno" placeholder="请输入班级编号">
                                    </div>
                                    <div class="form-group">
                                        <label>班级名称</label>
                                        <input class="form-control" type="text" name="name" id="name" placeholder="请输入班级名称">
                                    </div>
                                    <div class="form-group">
