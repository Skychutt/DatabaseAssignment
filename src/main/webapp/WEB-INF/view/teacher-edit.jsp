                                ...
                                <form id="teacherForm" onsubmit="return false;">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label>工号</label>
                                            <input class="form-control" type="text" id="tno" value="<%= teacher == null ? "" : teacher.getTno() %>" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>密码</label>
                                    ...
                                    <div class="form-group">
                                        <label>姓名</label>
                                        <input class="form-control" type="text" id="tname" value="<%= teacher == null || teacher.getTname() == null ? "" : teacher.getTname() %>">
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-primary" type="button" onclick="submitForm()">保存</button>
                                        <button class="btn btn-default" type="button" onclick="location.href='${pageContext.request.contextPath}/teacher'">返回列表</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    function submitForm() {
        $.post("${pageContext.request.contextPath}/teacher", {
            r: "edit",
            tno: $("#tno").val(),
